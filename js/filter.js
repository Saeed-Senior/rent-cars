...
<div class="card__image second-slider swiper-container">
   <div class="swiper-wrapper">
      <div class="swiper-slide">
         <img src="${cars[6].image1}" alt="">
      </div>
   </div>
   <div class="card-pagination swiper-pagination"></div>
</div>
<div class="card__information">
   <h3 class="card__name" translate='no'>Toyota Camry <span class="card__new">${cars[6].new}</span></h3>
   <div class="card__buttons">
                           <button class="card__first-button" data-lang='booking'>Бронировать</button>
                           <a href="_more.html?${cars[6].image1}&${cars[6].name}&${cars[6].price.day}" class="card__second-button" data-lang='more'>Подробнее</a>
                           </div>
</div>
</div>
...
<div class="card__image second-slider swiper-container">
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
         <img src="${cars[10].image1}" alt="">
      </div>
   </div>
   <div class="card-pagination swiper-pagination"></div>
</div>
<div class="card__information">
   <h3 class="card__name" translate='no'>Lamborghini Huracan <span class="card__new">${cars[10].new}</span></h3>
   <div class="card__buttons">
                           <button class="card__first-button" data-lang='booking'>Бронировать</button>
                           <a href="_more.html?${cars[10].image1}&${cars[10].name}&${cars[10].price.day}" class="card__second-button" data-lang='more'>Подробнее</a>
                           </div>
</div>
</div>
...
<div class="card__image second-slider swiper-container">
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
         <img src="${cars[5].image1}" alt="">
      </div>
   </div>
   <div class="card-pagination swiper-pagination"></div>
</div>
<div class="card__information">
   <h3 class="card__name" translate='no'>Mercedes S-class <span class="card__new">${cars[5].new}</span></h3>
   <div class="card__buttons">
                           <button class="card__first-button" data-lang='booking'>Бронировать</button>
                           <a href="_more.html?${cars[5].image1}&${cars[5].name}&${cars[5].price.day}" class="card__second-button" data-lang='more'>Подробнее</a>
                           </div>
</div>
</div>
`